...
<fieldset>
<input type="checkbox" class ="contact-submit yes" data-submit="...Sending" value="sold"  onclick="mark(${id})">Mark as sold<br>
...
/*
   <div class="view row">
      <div class="grid-md-9 grid-md-push-3">
<div class="slideshow-container">
  <div class="mySlides2">
   <img src="img/view.jpg" alt="Nature" class="responsive" width="600" height="400">
  </div>

  <div class="mySlides2">
    <img src="img/view2.jpg" alt="Nature" class="responsive" width="600" height="400">
  </div>

  <div class="mySlides2">
   <img src="img/view3.jpg" alt="Nature" class="responsive" width="600" height="400">
  </div>

  <a class="prev" onclick="plusSlides(-1, 1)" class="mark">&#10094;</a>
  <a class="next" onclick="plusSlides(1, 1)" class="mark">&#10095;</a>
</div>
...
<a href="report.html">Report Ad</a>
          
        </div>

<!-- Trigger/Open The Modal -->
<a href="purchase-order.html"><button class="mybtn wide">Make Purchase</button></a>
